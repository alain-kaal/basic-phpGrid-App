...
define('PHPGRID_DB_PASSWORD', 'haku-10315'); // database password
...
/* You should define SERVER_ROOT manually when use Apache 
  alias directive or IIS virtual directory */
 define('SERVER_ROOT', 
...
// indicating framework integrating - not used yet
// define('FRAMEWORK', '');

// *** MUST SET TO FALSE WHEN DEPLOYED IN PRODUCTION ***
// define('DEBUG', false); 
 
// use Cloud CDN by default. False to use the local libraries
// define('CDN', true);       
